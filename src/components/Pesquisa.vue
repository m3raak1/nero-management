            ...
            <a :href="`pesquisas/${search.researchId}.html`">
                <div class="flex justify-between">
                    ...
                    <div class="h-auto flex">
                        <span class="text-white h-full flex items-center bg-sapphire-gradient px-4 rounded-3xl text-sm">Responsável: {{ search.responsible[0].name }}</span>
                ...
                <div class="flex justify-between text-white">
                    <span class="text-white flex items-center bg-metal-gradient py-2 px-4 rounded-3xl text-sm">Equipe: {{  search.team[0].name }}</span>
